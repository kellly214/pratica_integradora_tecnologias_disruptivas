...
const ListarTarefa = () => {
  ...
  const [tarefa, setTarefa] = useState(null); // Corrigido para null
  const [idTarefaSelecionada, setIdTarefaSelecionada] = useState(null); // Corrigido para null
                ...
                {tarefas.map((row, indice) => (
                  <TableRow
                    ...
                    sx={{
                      ...
                      backgroundColor: indice % 2 === 0 ? 'yellow' : 'inherit', // Alterna a cor de fundo
                    }}
                  >
                    <TableCell component="th" scope="row">
                      {row.idTarefa}
                    </TableCell>
                    <TableCell>{row.tituloTarefa}</TableCell> {/* Corrigido */}
